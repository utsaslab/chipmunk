...
type Config struct {
	...
	// Check for crash consistency bugs
	CrashConsistency bool `json:"crash_consistency,omitempty"`
	// Capture coverage from mounting crash state
	CaptureMountCov bool `json:"capture_mount_cov,omitempty"`
	// Restart executor after each test
	Restart bool `json:"restart,omitempty"`
	// fuzz file system as module
	Module bool `json:"module,omitempty"`
	// Path to logger on VM
	LoggerPath string `json:"logger,omitempty"`
	// Reload module and logger after each test
	Reload bool `json:"reload,omitempty"`
	// Indicate which file system to test
	FileSystem string `json:"filesystem,omitempty"`
	// give the path to the fs module to load
	FileSystemPath string `json:"fs_path,omitempty"`
	// Indicate which tester to run (ace or fuzzer)
	Tester string `json:"tester,omitempty"`
	// Shared directory for crash consistency testing
	TesterDir string `json:"tester_dir,omitempty"`
	...
	SyzId int `json:"syz_id,omitempty"`
	...
	DashboardOnly   bool   `json:"dashboard_only,omitempty"`
