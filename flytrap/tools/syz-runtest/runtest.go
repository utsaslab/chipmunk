...
func (mgr *Manager) boot(name string, index int) (*report.Report, error) {
	...
	cmd := instance.FuzzerCmd(fuzzerBin, executorBin, name,
		...
		mgr.cfg.CrashConsistency, mgr.cfg.CaptureMountCov,
		mgr.cfg.LoggerPath, mgr.cfg.FileSystem, mgr.cfg.Module, mgr.cfg.Restart, mgr.cfg.Reload, mgr.cfg.FileSystemPath)
