...
// TODO: memcpy in PMFS can't be kprobed since it causes the kernel to lock up,
// but you could replace memcpy with a custom implementation in PMFS that you CAN log
...
static int __init logger_init(void) {
    ...
    // set up pmfs_flush_buffer kprobe list
