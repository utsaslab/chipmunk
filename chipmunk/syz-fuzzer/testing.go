...
func checkMachine(args *checkArgs) (*rpctype.CheckArgs, error) {
	...
	//args.ipcExecOpts.ConsistencyCheck = true
...
func checkSimpleProgram(args *checkArgs, features *host.Features) error {
	...
	if err := host.Setup(args.target, features, args.featureFlags, args.ipcConfig.ExecutorCC); err != nil {
	...
	output, info, hanged, err := env.Exec(args.ipcExecOpts, p, "test")
	if err != nil {
