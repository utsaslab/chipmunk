...
DIR=chroot
PREINSTALL_PKGS=openssh-server,curl,tar,gcc,make,g++,libc6-dev,time,strace,sudo,less,psmisc,selinux-utils,policycoreutils,checkpolicy,selinux-policy-default,debian-ports-archive-keyring
